...
const uploadGalleryPhoto = multer({ storage: galleryStorage, limits: { fileSize: 8 * 1024 * 1024 } });

module.exports = { uploadShopImage, uploadAvatar, uploadServiceImage, uploadGalleryPhoto };
